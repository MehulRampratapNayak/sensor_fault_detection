...
class DataValidation:
    ...
    def is_required_columns_exists (self,base_df:pd.DataFrame,current_df:pd.DataFrame,report_key_name:str)->bool:
        """
        This function will check if all required columns are available after missing columns drop

        base_df: Accepts a pandas dataframe
        current_df: Accepts a pandas dataframe
        report_key_name: Name of the report
        =====================================================================================
        returns True if atleast a single column is available after missing columns drop else False
        """
